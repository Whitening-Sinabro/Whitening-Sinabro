...
Never send passwords, API keys, private customer data, or production account credentials in a public issue or initial inquiry. Use anonymized evidence only.
